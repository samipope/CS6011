...
//     if(Part1.binarySearch(arr1, 2) == false) System.out.println("Binary search is broken");
...
//     if(Part1.binarySearch(arr2, 18) == true) System.out.println("Binary search is broken");
