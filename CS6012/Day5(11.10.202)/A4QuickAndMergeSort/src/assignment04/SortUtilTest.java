...
//    }
  ...
  //      assertEquals(testing,test1);
      ...
      ArrayList<Integer> test2 = new ArrayList<>(Arrays.asList(4,5,6,1,2));
      SortUtil.merge(test2,0,2,4,Comparator.naturalOrder());
      ArrayList<Integer> sorted2 = new ArrayList<>(Arrays.asList(1,2,4,5,6));
      assertEquals(test2, sorted2);


      ArrayList<Integer> test3 = new ArrayList<>(Arrays.asList(5,2,3));
      SortUtil.merge(test3,0,0,2,Comparator.naturalOrder());
      ArrayList<Integer> sorted3 = new ArrayList<>(Arrays.asList(2,3,5));
