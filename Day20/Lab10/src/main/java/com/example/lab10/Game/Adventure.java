package com.example.lab10.Game;

import com.example.lab10.Items.Item;
import com.example.lab10.Rooms.Cell;
import com.example.lab10.Rooms.MEB3155;
import com.example.lab10.Rooms.Room;
import com.example.lab10.Rooms.weaponsRoom;
...
public class Adventure {
    ...
    public static void main( String[] args ) {
        ...
        Room cell = new Cell();
        Room MEB3155 = new MEB3155();
        Room WeaponsRoom = new weaponsRoom();

        hall.addConnection(WeaponsRoom);
        hall.addConnection(MEB3155);
